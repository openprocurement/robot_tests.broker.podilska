...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'podilska_Viewer'  Login  ${username}
...
Завантажити документ
  ...
  podilska.Пошук тендера по ідентифікатору  ${username}  ${TENDER}
...
Отримати інформацію з поля предмету
  [Arguments]  ${username}  ${tender_uaid}  ${item_id}  ${field_name}
  ${return_value}=  podilska.Отримати інформацію із тендера  ${username}  ${tender_uaid}  items[${item_id}].${field_name}
  [return]  ${return_value}
...
Завантажити документ в тендер з типом
  ...
  podilska.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  podilska.Завантажити документ до форми з типом  ${username}  ${tender_uaid}  ${filepath}  illustration
...
Завантажити ілюстрацію
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  podilska.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  illustration
...
Додати публічний паспорт активу
  [Arguments]  ${username}  ${tender_uaid}  ${vdr_url}
  podilska.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  x_dgfPublicAssetCertificate

Додати офлайн документ
  [Arguments]  ${username}  ${tender_uaid}  ${accessDetails}
  podilska.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  x_dgfAssetFamiliarization
...
Додати предмет закупівлі
  ...
  podilska.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  ${index}=  podilska.Отримати кількість предметів в тендері  ${username}  ${tender_uaid}
...
Отримати документ
  ...
  Run Keyword If  ${SEARCH_MODE}=='assets'  podilska.Пошук об’єкта МП по ідентифікатору  ${username}  ${tender_uaid}
  ...  ELSE IF  ${SEARCH_MODE}=='lots'  podilska.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
  ...  ELSE  podilska.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
...
Дискваліфікувати постачальника
  ...
  podilska.Оновити сторінку з тендером  ${username}  ${tender_uaid}
  ${award_index}=  inc  ${award_index}
...
Отримати інформацію із об'єкта МП
  ...
  ${return_value}=  Run Keyword  podilska.Отримати інформацію про ${fieldname}
  [return]  ${return_value}

Отримати інформацію з активу об'єкта МП
  [Arguments]  ${username}  ${asset_uaid}  ${item_id}  ${field_name}
  ${return_value}=   Run KeyWord   podilska.Отримати інформацію з поля предмету  ${username}  ${asset_uaid}  ${item_id}  ${field_name}
  [Return]  ${return_value}
...
Внести зміни в об'єкт МП
  ...
  Run KeyWord  podilska.Внести зміни в об'єкт МП поле  ${fieldname}  ${fieldvalue}
  Click Element  id=btnPublic

Внести зміни в об'єкт МП поле 
  [Arguments]  ${fieldname}  ${fieldvalue}
  podilska.Внести зміни до елементу за шляхом  //*[@name = '${fieldname}']  ${fieldname}  ${fieldvalue}
...
Завантажити документ в об'єкт МП з типом
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}  ${doc_type}
  podilska.Пошук об’єкта МП по ідентифікатору  ${username}  ${tender_uaid}
  podilska.Завантажити документ до форми з типом  ${username}  ${tender_uaid}  ${filepath}  ${doc_type}

Завантажити ілюстрацію в об'єкт МП
  [Arguments]  ${username}  ${asset_uaid}  ${filepath}
  podilska.Завантажити документ в об'єкт МП з типом  ${username}  ${asset_uaid}  ${filepath}  illustration

Завантажити документ для видалення об'єкта МП
  [Arguments]  ${username}  ${asset_uaid}  ${filepath}
  podilska.Завантажити документ в об'єкт МП з типом  ${username}  ${asset_uaid}  ${filepath}  cancellationDetails
...
Додати умови проведення аукціону номер 0
  ...
  podilska.Пошук лоту по ідентифікатору  ${username}  ${lot_uaid}
...
Оновити сторінку з об'єктом МП
  [Arguments]  ${username}  ${lot_uaid}
  podilska.Пошук об’єкта МП по ідентифікатору  ${username}  ${lot_uaid}
...
Отримати інформацію з активу лоту
  ...
  ${return_value}=   Run KeyWord   podilska.Отримати інформацію з поля предмету  ${username}  ${lot_uaid}  ${item_id}  ${field_name}
  [Return]  ${return_value}
...
Завантажити ілюстрацію в лот
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  podilska.Завантажити документ в лот з типом  ${username}  ${tender_uaid}  ${filepath}  illustration

Завантажити документ для видалення лоту
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  podilska.Завантажити документ в лот з типом  ${username}  ${tender_uaid}  ${filepath}  cancellationDetails
...
Внести зміни в лот
  [Arguments]  ${username}  ${tender_uaid}  ${fieldname}  ${fieldvalue}
  podilska.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
  Run KeyWord  podilska.Внести зміни в лот поле  ${fieldname}  ${fieldvalue}
  Click Element  id=btnPublic
...
Внести зміни в умови проведення аукціону
  ...
  podilska.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
  Run Keyword If  '${fieldname}' == 'auctionPeriod.startDate'  podilska.Внести дату та час  _auction_${item_id}_auctionPeriod_startDate  ${fieldvalue}
  ...  ELSE  podilska.Внести зміни до елементу за шляхом  //*[@name= 'auctions[${item_id}].${fieldname}']  ${fieldname}  ${fieldvalue}
  Click Element  id=btnPublic
...
Активувати контракт
  ...
  Sleep   60
  podilska.Пошук договору по ідентифікатору  ${username}  ${contract_uaid}
...
Отримати інформацію із договору
  ...
  podilska.Пошук договору по ідентифікатору  ${username}  ${contract_uaid}
  ${return_value}=  Run Keyword  podilska.Отримати інформацію про contract_${fieldname}
  [return]  ${return_value}

Отримати інформацію з активу в договорі
  [Arguments]  ${username}  ${contract_uaid}  ${item_id}  ${field_name}
  podilska.Пошук договору по ідентифікатору  ${username}  ${contract_uaid}
  ${return_value}=   Run KeyWord   podilska.Отримати інформацію з поля предмету  ${username}  ${contract_uaid}  ${item_id}  ${field_name}
  [Return]  ${return_value}
